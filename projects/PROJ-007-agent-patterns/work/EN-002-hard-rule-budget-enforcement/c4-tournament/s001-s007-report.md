...
| OB-04 | **Constitution status is DRAFT**: `TOM_CONSTITUTION.md` is version 1.0/1.1 with `Status: DRAFT`. P-001, P-002, P-020, P-022 cited in this review are themselves from a DRAFT document. Constitutional compliance cannot be fully authoritative until the constitution is baselined. | S-007 general | `docs/governance/TOM_CONSTITUTION.md` line 8 |
