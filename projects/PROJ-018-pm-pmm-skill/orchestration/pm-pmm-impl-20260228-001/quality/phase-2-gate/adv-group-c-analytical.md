...
| Evidence Quality | 0.86 | References Issue #123, architecture.md, frontmatter-schema.md, quality-enforcement.md, agent-development-standards.md, JERRY_CONSTITUTION.md. Missing: no reference to security review findings despite the security review identifying SKILL.md-relevant concerns (routing manipulation TH-007). |
