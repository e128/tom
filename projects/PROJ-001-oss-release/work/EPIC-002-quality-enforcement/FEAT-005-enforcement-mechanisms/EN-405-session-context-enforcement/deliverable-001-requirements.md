...
| FR-405-022 | The `<decision-criticality>` section SHALL include the auto-escalation rules: AE-001 (TOM_CONSTITUTION.md -> C3 min), AE-002 (.claude/rules/ -> C3 min), AE-003 (new ADR -> C3 min), AE-004 (modified baselined ADR -> C4), AE-005 (security code -> C3 min). | MEDIUM | SRC-003 (Auto-Escalation Rules) | Auto-escalation rules fire before strategy selection; Claude must know them from session start. |
