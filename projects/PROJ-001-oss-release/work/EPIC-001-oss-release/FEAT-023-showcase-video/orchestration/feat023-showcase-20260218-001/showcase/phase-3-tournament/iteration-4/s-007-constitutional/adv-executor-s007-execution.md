...
The v4 script is a **document deliverable** (markdown script artifact with production direction). It is NOT code. Applicable rule sets: `markdown-navigation-standards.md`, `quality-enforcement.md`, and `TOM_CONSTITUTION.md` principles applicable to agent-produced creative/specification documents.
