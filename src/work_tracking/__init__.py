...
This bounded context handles the core domain concepts for work item lifecycle
management, quality gate enforcement, and task tracking within the Tom Framework.
