...
- `/claude-revision` skill (`.claude/skills/claude-revision/SKILL.md`) — periodic health check for agents; has no agents/ subdirectory (runs directly in main context)
