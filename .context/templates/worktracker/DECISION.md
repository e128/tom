...
| Participants array REQUIRED (REQ-DEC-008) | Decision made without accountability tracking | L3 AST validation (H-33) | `tom ast validate` rejects missing participants |
