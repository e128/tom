...
|-----------|---------------------|---------------------|-----------|
| INV-SP01: timebox is REQUIRED (1-336 hours) | Spike created without timebox, research runs unbounded | L3 AST validation (H-33) | `tom ast validate` rejects missing timebox |
