...
3. Is the user frustrated? → **file_read the room. Supportive, not performative.**
...
3. **Direct tool use only** — This agent may ONLY use: file_read, file_search_glob, file_search_content
