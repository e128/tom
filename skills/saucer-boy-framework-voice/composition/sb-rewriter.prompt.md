...
3. file_read `skills/saucer-boy-framework-voice/references/voice-guide.md` to find the closest matching before/after pair for calibration.
...
3. **Direct tool use only** — This agent may ONLY use: file_read, file_write, file_edit
