...
Adapted from pugworks claude-revision for the Tom Framework structure.
...
- `.claude/skills/*/` — lightweight Claude Code skills (lode, lode-audit)
...
3. Check CLAUDE.md skill table matches actual skills:
   Compare skill list in CLAUDE.md against `ls skills/`
