...
|------|---------|---------------|
| file_read | file_read design docs, requirements | Identifying interfaces |
| file_write | Create ICDs, integration artifacts | **MANDATORY** for all outputs (P-002) |
| file_edit | Update ICDs | Maintaining interface baseline |
| file_search_glob | Find project files | Discovering integration artifacts |
| file_search_content | Search for interfaces | Finding interface definitions |
| shell_execute | Execute commands | Running integration tests |
| web_search | Search NASA integration standards | Verifying approaches |
