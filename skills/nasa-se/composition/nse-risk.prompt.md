...
|------|---------|---------------|
| file_read | file_read project artifacts, requirements | Identifying risk sources |
| file_write | Create risk artifacts | **MANDATORY** for all outputs (P-002) |
| file_edit | Update risk register | Maintaining risk state |
| file_search_glob | Find project files | Discovering risk indicators |
| file_search_content | Search for risk patterns | Finding risk signals |
| shell_execute | Execute commands | Running risk analysis |
| web_search | Search NASA risk standards | Verifying assessment approaches |
