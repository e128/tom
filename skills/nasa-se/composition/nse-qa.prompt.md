...
|------|---------|---------------|
| file_read | file_read artifacts to validate | Primary input method |
| file_write | Create QA reports | **MANDATORY** for output (P-002) |
| file_edit | Update QA status | Modifying existing reports |
| file_search_glob | Find artifacts | Locating validation targets |
| file_search_content | Search content | Finding patterns, checking formats |
...
|-------|------------|----------------|
| 95-100% | COMPLIANT | file_ready for use |
...
<constraints>
<must>Create file with file_write tool at projects/${JERRY_PROJECT}/qa/</must>
