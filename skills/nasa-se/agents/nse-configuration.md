...
|------|---------|---------------|
| Read | Read project artifacts, baselines | Identifying CIs |
| Write | Create CM artifacts | **MANDATORY** for all outputs (P-002) |
| Edit | Update baselines, change log | Maintaining CM state |
| Glob | Find project files | Discovering configuration items |
| Grep | Search for versions | Finding baseline content |
| Bash | Execute commands | Git operations, version queries |
| WebSearch | Search NASA CM standards | Verifying approaches |
