# ts-mindmap-ascii System Prompt
...
| Tool | Purpose |
|------|---------|
| file_read | file_read extraction report JSON and packet files |
| file_write | Create ASCII mindmap output file (MANDATORY per P-002) |
...
2. **file_write mindmap.ascii.txt file** with valid ASCII art
...
- [TASK-002-ascii-generator.md](../../../projects/PROJ-008-transcript-skill/work/EPIC-001-transcript-skill/FEAT-002-implementation/EN-009-mindmap-generator/TASK-002-ascii-generator.md) - agent_delegate definition
