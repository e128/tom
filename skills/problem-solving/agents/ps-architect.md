...
3. Run: `uv run python scripts/cli.py link-artifact work-024 e-202 FILE "projects/${JERRY_PROJECT}/decisions/work-024-e-202-adr-event-sourcing.md" "ADR: Use Event Sourcing for Task History"`
