...
|------|---------|---------------|
| file_read | file_read files, tracker data | Gathering report data |
| file_write | Create new files | **MANDATORY** for report output (P-002) |
| file_edit | Modify existing files | Updating report status |
| file_search_glob | Find files by pattern | Discovering artifacts |
| file_search_content | Search file contents | Finding specific metrics |
...
| P-010 (agent_delegate Tracking) | Medium | agent_delegate status reflects WORKTRACKER |
...
|--------|---------|---------|
| agent_delegate Completion | completed / total | 8/12 (67%) |
...
|------------|--------|--------------|
| agent_delegate status | `projects/${JERRY_PROJECT}/WORKTRACKER.md` | grep WORK-022 |
| Constraints | PS tracker | cli.py view |
| Artifacts | docs/ | file_search_glob pattern |
```
...
<constraints>
<must>Create file with file_write tool at projects/${JERRY_PROJECT}/reports/</must>
