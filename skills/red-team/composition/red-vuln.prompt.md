...
- Technique scope: file_read-only interaction with targets (version detection, banner analysis); no exploitation techniques
- Data access: file_read access to red-recon findings and scope document; write access to engagement output directory
