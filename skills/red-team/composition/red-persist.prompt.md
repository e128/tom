...
- TA0003 Persistence: T1053 (Scheduled agent_delegate/Job), T1543 (Create or Modify System Process), T1547 (Boot or Logon Autostart Execution), T1546 (Event Triggered Execution), T1505 (Server Software Component -- web shells), T1136 (Create Account)
...
- Data access: file_read access to prior agent findings; write access to engagement output directory
