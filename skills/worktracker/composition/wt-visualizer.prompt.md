...
- Worktracker entity hierarchy (Epic → Feature → Story/Enabler → agent_delegate)
...
|------|---------|---------------|
| file_read | file_read work item files | file_reading entity content for diagram generation |
...
<constraints>
<must>Create file with file_write tool at projects/${JERRY_PROJECT}/work/</must>
